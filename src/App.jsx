                ...
                {tab==="numbers" && (
                  <div className="nums-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
                    {[
                      ...
                      {icon:"noise",label:"Perimeter Noise",value:`${dc.Noise_DB||"?"} dB`,plain:"Comparable to heavy traffic or a loud restaurant, sustained 24/7 including overnight hours. Low-frequency noise from cooling systems and generators can penetrate walls and windows beyond the perimeter.",color:dc.Noise_DB>=70?"#ef4444":dc.Noise_DB>=60?"#f97316":"#3b82f6"},
